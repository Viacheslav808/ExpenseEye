                    ...
                    .addCallback(new RoomDatabase.Callback() {
                        ...
                        public void onCreate(@NonNull SupportSQLiteDatabase db) {
                            ...
                            Executors.newSingleThreadExecutor().execute(() -> {
                                ...
                                // Create default accounts for THIS user only
                                if (accountDao.getCountForUser((int) userId) == 0) {
                                    accountDao.insert(new Account(1, (int) userId, "Cash", 0.0));
                                    accountDao.insert(new Account(2, (int) userId, "Bank Account", 0.0));
